    ...
    <>
      <section className="relative top-20 mx-auto">
        <div className="flex flex-wrap justify-center gap-4">
          <div className="card-with-icon-and-description flex justify-center items-center">
            <svg
            ...
            <div>
              <h5 className="card-title-text">155</h5>
              <p className="sub-title-text p-0 font-normal">Questions</p>
            </div>
          </div>
          <div className="card-with-icon-and-description flex justify-center items-center">
            <svg
            ...
            <div>
              <h5 className="card-title-text">155</h5>
              <p className="sub-title-text p-0 font-normal">Categories</p>
            </div>
          </div>
          <div className="card-with-icon-and-description flex justify-center items-center">
            <svg
            ...
            <div>
              <h5 className="card-title-text">155</h5>
              <p className="sub-title-text p-0 font-normal">Concepts</p>
            </div>
          </div>
        </div>
